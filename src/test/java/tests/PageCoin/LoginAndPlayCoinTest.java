...
*/
            ...
            step("Проверка повышения ставки на max",() ->{
                ...
                Equals.equals(BET_COIN,ExpectedBet,"Проверка кнопки повышения ставки на max работает","Проверка кнопки повышения ставки на max не работает");
                TakeScreenshot.TakeScreenShot("Скриншот: Выставление мак ставки");
            });

            step("Проверка ставка Min",() ->{
                basepage.ClickByXpath(BUTTON_BET_MIN_COIN);
                WaitUtils.waitForPageToLoad();
                Equals.equals(BET_COIN,"1.00","Проверка ставка Min работает","Проверка ставка Min не работает");
            });
