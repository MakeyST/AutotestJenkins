...
public class LoginAndTrytoPlayCrashTest extends BaseTest {
    ...
    public void checkButtomPlayCrash() {
        ...
        step("Проверка повышения ставки на 1",() -> {
            ...
            Equals.equals(BET_CRASH,"2","Проверка кнопки повышения ставки на 1 работает","Проверка кнопки повышения ставки на 1 не работает");
        });
        ...
        step("Проверка повышения ставки на 10",() ->{
            ...
            Equals.equals(BET_CRASH,"11","Проверка кнопки повышения ставки на 10 работает","Проверка кнопки повышения ставки на 10 неработает");
        });
        step("Проверка повышения ставки на 50",() ->{
            WaitUtils.waitForPageToLoad();
            basepage.ClickByXpath(BUTTON_BET_X50);
            Equals.equals(BET_CRASH,"61","Проверка кнопки повышения ставки на 50 работает","Проверка кнопки повышения ставки на 50 работает");
        });
        step("Проверка повышения ставки на 100",() ->{
            basepage.ClickByXpath(BUTTON_BET_X100);
            Equals.equals(BET_CRASH,"161","Проверка кнопки повышения ставки на 100 работает","Проверка кнопки повышения ставки на 100 работает");
        });
        step("Проверка повышения ставки на 200",() ->{
            basepage.ClickByXpath(BUTTON_BET_X200);
            Equals.equals(BET_CRASH,"361","Проверка кнопки повышения ставки на 200 работает","Проверка кнопки повышения ставки на 200 работает");
        });
        step("Проверка повышения ставки на max",() ->{
            ...
            Equals.equals(BET_CRASH,ExpectedBet,"Проверка кнопки повышения ставки на max работает","Проверка кнопки повышения ставки на max работает");
            TakeScreenshot.TakeScreenShot("Скриншот: Выставление макc ставки");
        });
        step("Проверка повышения автостопа на 0,1",() ->{
            ...
            TakeScreenshot.TakeScreenShot("Скриншот: Скриншот повышение автостопа");
        });
        step("Проверка понижение автостопа на 0,1",() ->{
            basepage.ClickByXpath(AUTOSTOP_DOWN);
            Equals.equals(AUTOSTOP,"2.00","Проверка кнопки понижение автостопа на 0,1 работает","Проверка кнопки понижение автостопа на 0,1 не работает");
            TakeScreenshot.TakeScreenShot("Скриншот: Скриншот понижения автостопа");
        });
        step("Проверка выключения",() ->{
            ...
            TakeScreenshot.TakeScreenShot("Скриншот: Скриншот выключения");
        });
        step("Проверка включения",() ->{
            ...
            String newPosition = Autostop.getAttribute("class");
            ChengedPosition.CheckChenger(initialPosition,newPosition);
            TakeScreenshot.TakeScreenShot("Скриншот: Скриншот включения");
        });
        ...
        step("Нажатие кнопки Играть ", () -> {
            ...
            TakeScreenshot.TakeScreenShot("Скриншот: Скриншот конец теста");
        });
        }catch(Exception e) {
        }
    }
