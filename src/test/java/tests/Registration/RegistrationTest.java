        ...
        public void checkRedirectAfterRegistration () {
            try{
                ...
                step("Ввод логина", () -> {
                    ...
                    TakeScreenshot.TakeScreenShot("Скриншот: Скриншот логина");
                });

                step("Ввод пароля", () -> {
                    basepage.InputTextByXpath(INPUT_PASSWORD_REGISTRATION,PASSWORD_LOGIN);
                    TakeScreenshot.TakeScreenShot("Скриншот: Скриншот пароля");
                });
                ...
                WaitUtils.waitForPageToLoad();
                TakeScreenshot.TakeScreenShot("Скриншот: домашняя страница авторизованного пользователя");
        }catch (Exception e) {
        }
    }
}
